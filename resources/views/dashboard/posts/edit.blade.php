...
<div class="mb-3">
  <label for="formFile" class="form-label"><span data-feather="camera"></span></label>
  {{-- Penghapusan Gambar Yang sudah Diupdate --}}
...
<div class="mb-3">
    <label for="body" class="form-label"><span data-feather="mail"></label> 
...
<a href="/dashboard/posts" type="submit" class="btn btn-primary">Back</a>
</form>


{{-- Otomatis Mengisikan Slug --}}
<script>
  // #id
